    ...
    >
      <div className="text-center mb-10">
        ...
        >
          ...
          <span className="text-sm font-semibold text-[#38BDF8] uppercase tracking-wider">Technology Partners</span>
        </motion.div>

        <h3 className="text-3xl md:text-4xl font-bold text-white mb-2">
          Powered By <span className="text-[#38BDF8]">Leading Cloud Providers</span>
        </h3>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {partners.map((partner, index) => (
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-[#38BDF8]/50 rounded-xl p-8 text-center transition-all duration-300 group"
          >
            ...
            <div className="text-lg font-bold text-white mb-2 group-hover:text-[#38BDF8] transition-colors">
              {partner.name}
            </div>
