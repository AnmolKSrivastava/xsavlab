      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            From Our <span className="text-[#38BDF8]">Blog</span>
          </h2>
        ...
        {posts.length === 0 ? (
          ...
          >
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-12 max-w-2xl mx-auto">
              <FileText className="w-20 h-20 text-[#38BDF8]/50 mx-auto mb-6" />
          ...
          {posts.map((post, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-white mb-3 line-clamp-2 group-hover:text-[#38BDF8] transition-colors">
                  {post.title}
                </h3>
